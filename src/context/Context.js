...
const ContactsContextProvider = ({children}) => {
    ...
    return <contactsContext.Provider value={{addContact, getContacts, contacts: state.contacts, contactToEdit: state.contactToEdit, deleteContact, changeStatus, editContact, saveContact}}>
        {children}
